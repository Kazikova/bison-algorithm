...
problem = {
    ...
    'elity': 20,
    'overstep': 3.5,
    'iterations_to_enhance_run': 2, # run support parameter = number of iterations for run support strategy
    'filename': 'results/cec2017/basic bison/', # path where to save results
...
for x in range(1, 3):
    optimize(x, 10, optimization_algorithm)
